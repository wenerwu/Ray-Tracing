...
class HalfedgeMesh {
  ...
  */
  ...
  // my helper functions
  /* When edge collapse, two overlapped edge should be merged
  * h1 and h2 are each halfedge of 2 edges, and should be maintained
  */
  void mergeEdges(HalfedgeIter h1, HalfedgeIter h2);

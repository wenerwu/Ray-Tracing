...
class BVHAccel : public Aggregate {
 public:
  ...
  int compute_Bucket(Primitive *primitive, int bucketSize, int axis, int centroid, int leftMost, int rightMost);
   ...
   */
  void splitNode(const std::vector<Primitive *> &_primitives, BVHNode* node, size_t max_leaf_size);
